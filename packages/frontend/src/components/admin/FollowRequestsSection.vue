<template>
  <ElCard class="section" shadow="hover">
    ...
    <ElEmpty v-if="followRequests.length === 0" description="No pending follow requests" />
    <ElTable v-else :data="followRequests" style="width: 100%">
      <ElTableColumn prop="id" label="ID" min-width="140" />
      <ElTableColumn prop="actorId" label="Actor" min-width="280" show-overflow-tooltip />
...
import { ElButton, ElCard, ElEmpty, ElSpace, ElTable, ElTableColumn } from 'element-plus';
